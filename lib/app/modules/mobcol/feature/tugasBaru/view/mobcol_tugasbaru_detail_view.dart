            ...
            children: [
              ...
              MobcolContainer(
                children: [
                  ...
                  Text(
                    '${tugas['dateTime'].day} ${controller.monthsInYear[tugas['dateTime'].month]}, ${tugas['dateTime'].year}',
                  ...
                  Text('${tugas['policeNumber']}', style: AppTextStyles.bigBody),
                  SizedBox(height: 15),
                  ElevatedButton(
                    style: MobcolAppButtonStyle.goodButtonStyle(),
                    onPressed: (){
                      Get.toNamed(AppRoutes.mobileCollectionDetailCust, arguments: tugas);
                    }, 
              ...
              MobcolContainer(
                children: [
                  ...
                  Text('${tugas['angsuranKe']}',style: AppTextStyles.bigBody,),
                  const Divider(),
                  Text('Jumlah Angsuran', style: AppTextStyles.Navybodymed),
                  Text('Rp. ${tugas['money']}',style: AppTextStyles.bigBody,),
                  const Divider(),
              ...
              ElevatedButton(
                style: MobcolAppButtonStyle.goodButtonStyle(),
                onPressed: (){
                  Get.toNamed(AppRoutes.mobileCollectionKunjungan, arguments: tugas);
                }, 
