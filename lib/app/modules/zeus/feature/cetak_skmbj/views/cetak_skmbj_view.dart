...
class CetakSkmbjView extends GetView<CetakSkmbjController> {
  CetakSkmbjView({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              if (controller.dataSkmbj.isEmpty && !controller.isLoading.value) {
              ...
              return RefreshIndicator(
                ...
                child: ListView.builder(
                  ...
                  itemCount: controller.dataSkmbj.length,
                  itemBuilder: (_, index) {
                    final item = controller.dataSkmbj[index];
                    return Card(
